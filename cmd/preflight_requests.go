...
func computeFreeFromPods(node *corev1.Node, hpAlloc resource.Quantity, podsOnNode []corev1.Pod) (memFree resource.Quantity, hpFree resource.Quantity, warn string) {
...
// DEPRECATED: Use computeFreeFromPods with pre-fetched pods instead
