...
type WekaConfigValidationModule interface {
	...
	Validate(ctx context.Context, clients *kubernetes.K8sClients, config *WekaConfigContext) (interface{}, error)
}
...
// WekaConfigContext holds the objects being validated
type WekaConfigContext struct {
